```sql
CREATE OR ALTER FUNCTION fn_get_request_hours_by_Transaction(  
...
RETURN  
 ...
 SUM(CASE  
                ...
                WHEN @bOnlyRequestEnding = 0 AND tsm.nId_Sub_Tipo_Entidad IN(6, 7) THEN tsm.
dCantidad_Minutos  
                ELSE 0  
       ...
       SUM(CASE  
        ...
        SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 8 THEN tsm
.dCantidad_Minutos ELSE 0 END) AS CantidadTotalResta, -- Sumar horas a favor 2  
        ...
        CASE  
            WHEN @bShowNegativeDiff = 1 THEN (SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 6 THEN tsm.dCantidad_Minutos ELSE 0 END) -  
                                              SUM(CASE 
WHEN tsm.nId_Sub_Tipo_Entidad = 8 THEN tsm.dCantidad_Minutos ELSE 0 END))  
            ELSE  
                CASE  
