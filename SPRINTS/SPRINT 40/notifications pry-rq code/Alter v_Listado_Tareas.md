```sql
CREATE  OR ALTER  VIEW [dbo].[v_Listado_Tareas] as SELECT  
...
CONCAT(tb_project.sCodigo,' ',tb_project.sNombre_Proyecto_Sin_Prefijo)        sNombre_Proyecto,  
...
concat(r.sCodigo,' ',r.sNombre_SinPrefijo) sNombre_Requerimiento,  
