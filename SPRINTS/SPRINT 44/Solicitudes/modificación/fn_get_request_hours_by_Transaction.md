...
@bOnlyRequestEnding = 1 AND tsm.nId_Sub_Tipo_Entidad = 6 AND tsm.nId_Tipo_Entidad = 1 AND tsm.nEstado_Entidad = 3 THEN 1

WHEN @bOnlyRequestEnding = 0 AND tsm.nId_Sub_Tipo_Entidad IN(6, 7) AND tsm.nId_Tipo_Entidad = 1 AND tsm.nEstado_Entidad = 3 THEN 1
...
SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 8 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END) AS CantidadTotalResta, -- Sumar horas a favor 2

SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 8 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END) / 60 AS CantidadTotalResta_Horas,

CASE

WHEN @bShowNegativeDiff = 1 THEN (SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 6 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END) -

SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 8 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END))

ELSE

CASE

WHEN (SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 6 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END) - SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 8 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END)) < 0

THEN 0

ELSE (SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 6 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END) - SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 8 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END))
...
WHEN (SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 6 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END) -

SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 8 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END)) < 0

THEN 0

ELSE (SUM(CASE WHEN tsm.nId_Sub_Tipo_Entidad = 6 AND tsm.nEstado_Entidad = 3 THEN tsm.dCantidad_Minutos ELSE 0 END) -
