```sql
CREATE OR ALTER   PROCEDURE [dbo].[sp_get_hours_by_collaborator](
	@dFecha DATETIME,    
...
Select 
	...
	END AS nPermisos,
	CASE 
		WHEN @bPendiente = 0 THEN nTotal_Min_Favor_Extra_Apro + nTotal_Min_Favor_CompRecu_Apro
		ELSE nTotal_Favor 
	END AS nAFavor,
	CASE
		WHEN @bPendiente = 0 THEN nTotal_Min_Contra_Per_Apro + dTardanza_Con_Tolerancia
		ELSE nTotal_Contra 
	END AS nEnContra,
	CASE 
