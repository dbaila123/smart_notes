...
USE [tenant0001]
GO
/****** Object:  StoredProcedure [dbo].[sp_get_positive_negative_hours_by_Collaborator]    Script Date: 22/04/2025 15:49:49 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
    
ALTER   PROCEDURE [dbo].[sp_get_positive_negative_hours_by_Collaborator](        
    @dFecha DATETIME,        
