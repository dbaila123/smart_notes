```SQL
CREATE   PROCEDURE get_configuraciones(
...
INSERT INTO @configuraciones
 ...
 IF (SELECT COUNT(sConfiguration) from @configurations_request where sConfiguration = 'type_form') = 1
	BEGIN
		INSERT INTO @configuraciones
		SELECT
		nId_Form_Type sCodigo,
		sName sDecripcion,
		'TYPE_FORM' sTipo_Configuration
		FROM Form_Type
	END
