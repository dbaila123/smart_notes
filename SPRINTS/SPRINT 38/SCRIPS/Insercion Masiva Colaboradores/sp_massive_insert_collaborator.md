...
-------------------------INSERCION DE PERSONAS--------------------------------                    
 ...
 DECLARE @nId_Persona INT;                    
    SET @nId_Persona = SCOPE_IDENTITY();                    
                      DECLARE @EmailAlternativo NVARCHAR(255);     SET @EmailAlternativo = LOWER(REPLACE(CONCAT(@PrimerNombre, '.', @ApellidoPaterno, LEFT(@ApellidoMaterno, 1), '@materiagris.pe'),'ñ','n'));     
