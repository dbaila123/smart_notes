...
null,            
 ...
 BEGIN            
  ...
  SET @EmailEmpresarial = REPLACE
(@EmailEmpresarial, 'ñ', 'n');            
  ...
  dDatetime_Delete            
    ...
    @nId_Horario,            
       ...
       null    
        ...
        BEGIN
        DECLARE @Fecha_Ini DATE = CONVERT(DATE, @FechaIngreso);
        DECLARE @Fecha_Fin DATE = CONVERT(DATE, @Fecha_Actual);
            exec sp_create_asistence_by_colaborador @Fecha_Ini, @Fecha_Fin, @nId_Colaborador
        end
