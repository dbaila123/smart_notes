...
SET @sqlQuery = N'  
    ...
    SELECT   
        ...
        nTotal_Puntualidad,  
        nTotal_Tardanza,  
        nTotal_En_Tolerancia,  
        CAST(nTotal_Puntualidad * 100.0 / nTotal_Asistencias AS DECIMAL(5,2)) AS nPorcentaje_Puntualidad,  
        CAST(nTotal_Tardanza * 100.0 / nTotal_Asistencias AS DECIMAL(5,2)) AS nPorcentaje_Tardanza,  
        CAST(100 - (  
            CAST(nTotal_Puntualidad * 100.0 / nTotal_Asistencias AS DECIMAL(5,2)) +   
            CAST(nTotal_Tardanza * 100.0 / nTotal_Asistencias AS DECIMAL(5,2))  
        ) AS DECIMAL(5,2)) AS nPorcentaje_En_Tolerancia,  
        -- Esta columna es para verificación interna, puedes omitirla en la versión final  
        CAST(  
            CAST(nTotal_Puntualidad * 100.0 / nTotal_Asistencias AS DECIMAL(5,2)) +  
            CAST(nTotal_Tardanza * 100.0 / nTotal_Asistencias AS DECIMAL(5,2)) +  
            CAST(100 - (  
        ...
        AS DECIMAL(5,2)) AS nSuma_Porcentajes  -- Debería ser siempre 100.00  
    FROM BaseData  
    ORDER BY nTotal_Tardanza * 100.0 / nTotal_Asistencias DESC;'  
