...
-- Variables para el filtro din�mico
...
-- Convertir @SNombreColaborador a min�sculas

SET @sNombreColaborador = LOWER(@sNombreColaborador);

  

-- Construir condici�n de b�squeda por nombre
...
-- Construir condici�n de b�squeda por supervisor
...
-- Construir condici�n de b�squeda por estado del colaborador
