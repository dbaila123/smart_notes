...
IF @sFilterOne IS NOT NULL AND @sSlugToGetList <
> 'INDICADORES-MODULO-COLABORADORES-EQUIPOS'
...
INSERT INTO @conditions VALUES ('v.nId_Cola
borador IN (' + @CollaboratorsListTeam + ')');
...
ORD
ER BY v.dDatetime_Creador DESC
...
WHEN ut.dDatetime_Creador IS NULL THEN ''P
endiente''
...
COUNT(DISTINCT a.dFecha_Asistencia) AS
 nDias_Laborados
...
CAST(dl.nDias_Laborados AS DECIMAL(10, 2))) AS DECIMAL(10
, 2))
