...
BEGIN
	...
	IF NOT EXISTS (SELECT 1 FROM @Resultados WHERE sCategoria = 'BOLSA')
	 BEGIN
    ...
    GROUP BY t.nId_Colaborador, t.nId_Tarea, t.dFecha_Registro;

	 IF NOT EXISTS (SELECT 1 FROM @Resultados WHERE sCategoria = 'TAREO')
    BEGIN
        INSERT INTO @Resultados (sCategoria, sOrigen, nId_Colaborador, nCodigo)
        VALUES ('TAREO', 'Extras', @nId_Colaborador, 2);
    END
    ...
    SELECT
        ...
        tsm.nId_Colaborador,
        tsm.nId_Entidad AS nId_Tarea,
        tsm.dCantidad_Minutos,
		tsm.dDatetime_Creacion,
		3
    FROM Transacciones_Saldo_Mins tsm
    JOIN Tareas t ON tsm.nId_Entidad = t.nId_Tarea
